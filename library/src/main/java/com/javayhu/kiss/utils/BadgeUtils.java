 ...
 * 角标工具类
 * <p>
 * source code from code.oa.com: http://code.oa.com/v2/weima/detail/90053?comeFrom=push_43053
 * <p>
...
public class BadgeUtils {
    ...
    private volatile static BadgeUtils instance;
    ...
    public void setBadgeCount(Context context, int count) throws Throwable {
        ...
        ComponentName componentName = getLauncherComponent(context);
        currCount = count;
     ...
     *
     * @param context        context
     * @param totalUnreadMsg totalUnreadMsg
     */
    ...
    public boolean isSupportedHuaweiBadge(Context context) {
        ...
        try {
            ...
            Class<?> c = LauncherContext.getClassLoader().loadClass("com.huawei.android.launcher.LauncherProvider");
     ...
     * 微信通用方案
     * <p>
     * 需要声明  <uses-permission android:name="android.permission.READ_APP_BADGE" />
     *
     * @param context context
     * @param count   count
     */
